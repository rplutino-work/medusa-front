...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">Envío</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Dirección de envío</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Método de envío</h3>
        <div>
