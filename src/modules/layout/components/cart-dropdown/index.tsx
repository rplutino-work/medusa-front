...
const CartDropdown = () => {
  ...
  return (
    <div className="navbar-item h-full z-50" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Link href="/cart" passHref>
          <Popover.Button className="h-full">{`Carrito (${totalItems})`}</Popover.Button>
        </Link>
        <Transition
          show={state}
          as={Fragment}
              ...
              <div>
                <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                  ...
                  <div>
                    <Link href="/">
                      <a>
                        <span className="sr-only">Explorar productos</span>
                        <Button onClick={close}>Ver</Button>
                      </a>
                    </Link>
                  </div>
                </div>
